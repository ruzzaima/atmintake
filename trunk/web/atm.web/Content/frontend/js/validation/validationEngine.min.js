 ...
 (function($) {
	 ...
	 var methods = {
			...
			for (var i = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "min":
						...
						break;
                    case "minResult":
                        errorMsg = methods._getErrorMessage(form, field, rules[i], rules, i, options, methods._minResult);
                        break;
					case "max":
						errorMsg = methods._getErrorMessage(form, field, rules[i], rules, i, options, methods._max);
						break;
                    case "maxHeight":
                        errorMsg = methods._getErrorMessage(form, field, rules[i], rules, i, options, methods._maxHeight);
                        break;
					case "past":
		...
		*/
         ...
         * @return an error string if validation failed
         */
		_minResult: function(field, rules, i, options) {
		    var min = parseFloat(rules[i + 1]);
		    var len = parseFloat(field.val());
		...
		*/
         ...
         * @return an error string if validation failed
         */
		_maxHeight: function(field, rules, i, options) {
		    var max = parseFloat(rules[i + 1]);
		    var len = parseFloat(field.val());
    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "min": {
                    "regex": "none",
                    "alertText": "Tidak boleh kurang daripada  "
                },
                "minResult": {
                    "regex": "none",
                    "alertText": "Anda tidak layak. CGPA minimum adalah "
                },
                "max": {
                    "regex": "none",
                    "alertText": "Tidak boleh melebihi "
                },
                "maxHeight": {
                    "regex": "none",
                    "alertText": "Tinggi tidak boleh melebihi "
                },
                "past": {
                    "regex": "none",
                ...
                "phone": {
                    ...
                    "alertText": "Sila masukkan no telefon yang sah"
                },
                "email": {
                    // HTML5 compatible email regex ( http://www.whatwg.org/specs/web-apps/current-work/multipage/states-of-the-type-attribute.html#    e-mail-state-%28type=email%29 )
                    "regex": /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/,
                    "alertText": "Sila masukkan emel yang sah"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                    "alertText": "Sila masukkan angka sahaja"
                },
                "number": {
			...
			"func": function (field) {
			 ...
			 "alertText": "Invalid date, must be in YYYY-MM-DD"
                ...
                "onlyLetterSp": {
                    "regex": /^[a-zA-Z\ \']+$/,
                    "alertText": "Sila masukkan perkataan sahaja"
                },
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
