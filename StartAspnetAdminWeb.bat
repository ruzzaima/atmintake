start "C:\Program Files\Internet Explorer\iexplore.exe" "http://localhost:4437/asp.netwebadminfiles/default.aspx?applicationPhysicalPath=D:\project\work\atmintake\web&applicationUrl=/"
