    ...
    namespace SevenH.MMCSB.Atm.Domain
    {
          ...
          [Serializable]
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
						...
						public const string PropertyNameUserPassword = "UserPassword";
      ...
      get{ return m_LoginRoleCollection;}
            ...
            public virtual string UserPassword
						...
						set
						{
						if( String.Equals( m_UserPassword, value, StringComparison.Ordinal)) return;
						var arg = new PropertyChangingEventArgs(PropertyNameUserPassword, value);
						OnPropertyChanging(arg);
						if( !arg.Cancel)
						{
						m_UserPassword= value;
						OnPropertyChanged(PropertyNameUserPassword);
						}
						}
						get
						{
